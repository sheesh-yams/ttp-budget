...
export async function GET(
  ...
  try {
    const invoiceData = {
      ...
      paymentTerms:   (invoice as unknown as { paymentTerms: string | null }).paymentTerms,
      ...
      workspace: {
        ...
        addressLine1:        invoice.workspace.addressLine1,
        addressLine2:        invoice.workspace.addressLine2,
        city:                invoice.workspace.city,
        region:              invoice.workspace.region,
        postalCode:          invoice.workspace.postalCode,
      ...
      client: {
        ...
        legalName:      (invoice.client as unknown as { legalName: string | null }).legalName,
